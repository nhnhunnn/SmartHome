...
document.getElementById('attributeActionSelect').addEventListener('change', function () {
    ...
    currentPage = 1;
    fetchData(currentPage, rowsPerPage, grouptype, searchQuery, sortField, sortOrder);
});
...
async function fetchData(page, rowsPerPage, type, searchQuery, sortField, sortOrder) {
    try {
...
setInterval(() => fetchData(currentPage, rowsPerPage, grouptype, searchQuery, sortField, sortOrder), 2000);
fetchData(currentPage, rowsPerPage, grouptype, searchQuery, sortField, sortOrder);
