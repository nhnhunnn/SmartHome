...
async function fetchDataTable(page, rowsPerPage, type, searchQuery, sortField, sortOrder) {
    try {
        const response = await fetch(`http://localhost:5003/getData?limit=${rowsPerPage}&page=${page}&field=${type}&value=${searchQuery}&sortBy=${sortField}&sortDirection=${sortOrder}`);
