...
document.getElementById('attributeActionSelect').addEventListener('change', function () {
    ...
    currentPage = 1;
    fet(currentPage, rowsPerPage, grouptype, searchQuery, sortField, sortOrder);
});
...
async function fet(page, rowsPerPage, type, searchQuery, sortField, sortOrder) {
    try {
...
setInterval(() => fet(currentPage, rowsPerPage, grouptype, searchQuery, sortField, sortOrder), 2000);
fet(currentPage, rowsPerPage, grouptype, searchQuery, sortField, sortOrder);
